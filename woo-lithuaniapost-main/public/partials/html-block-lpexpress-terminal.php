...
?>
<br>
<label for="woo_lithuaniapost_lpexpress_terminal_id" class="woo_lithuaniapost_lpexpress_terminal_label" style="display: none;">
    <p class="woocommerce-input-wrapper woo_lithuaniapost_lpexpress_terminal_select_container form-row">
        <select class="woo_lithuaniapost_lpexpress_terminal_id" name="woo_lithuaniapost_lpexpress_terminal_id"
                style="width: 100%;">
